...
// BUG FIX: Validate required env vars at startup to fail fast
const required = [
  "MONGO_URI",
  "JWT_ACCESS_SECRET",
  "JWT_REFRESH_SECRET",
...
export default {
  ...
  JWT_ISSUER: process.env.JWT_ISSUER || "yourapp.com",
  JWT_AUDIENCE: process.env.JWT_AUDIENCE || "yourapp-client",

  // BUG FIX: was comparing string to boolean incorrectly in original
  ...
  SMTP_FROM_NAME: process.env.SMTP_FROM_NAME || "HappyArt Support",
